...
% define path to figs
\graphicspath{{./figs/}, {../visual_elements/figs/generated_figs/} }
...
%%%%%BELOW IS THE HACK NEEDED TO GET THE ARXIV TO WORK%%%%%
% \begin{figure}[h!]
% \centering
% \includegraphics[width=1.5\columnwidth]{QOC_landscapeCover.pdf}
% \end{figure}
...
\include{./sections/I_introduction.tex}
%\clearpage
...
\include{./sections/IIA_shortcuts_to_adiabaticity.tex}
\clearpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\include{./sections/IIB_optimal_control.tex}
\clearpage

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\include{./sections/IIC_reinforcement_learning.tex}
\clearpage
...
\include{./sections/III_outlook.tex}
\clearpage
